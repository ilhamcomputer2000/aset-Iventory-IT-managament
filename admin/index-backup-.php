...
if (!empty($kategori)) {
    $sql .= "Type = '$kategori' AND ";
}
$sql .= "(Nama_Barang LIKE '%$search_query%' OR 
...
$sql = "SELECT COUNT(id_peserta) FROM peserta WHERE 
...
<nav class="navbar p-10 shadow flex items-center">
        <div class="container mx-auto flex items-center">
            
            <!-- Form Pencarian -->
<form class="fixed right-4 top-4 flex items-center space-x-2 shadow-lg" action="index.php" method="get">
...
<body class="bg-gray-100">
    ...
    <div class="flex-grow ml-64 p-10 overflow-auto">
    <h4 class="text-center text-2xl font-semibold mb-10" style="margin-top: 50px; position: relative; width: 100%; text-align: center;">DAFTAR ASSET IT</h4>
        ...
        <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
            <thead>
                <tr class="bg-blue-200 text-left shadow-sm">
                    ...
                    <th class="px-4 py-2 border">Photo Barang</th>
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if ($_SESSION['role'] == 'super_admin') {
        echo "<a href='admin/update.p.php?id=" . $row['id'] . "' class='btn btn-warning'>Edit</a>";
        echo "<a href='delete.php?id=" . $row['id'] . "' class='btn btn-danger' onclick='return confirm(\"Yakin ingin menghapus?\")'>Hapus</a>";
        echo "<a href='admin/create.php' class='btn btn-primary'>Tambah</a>";
                ...
                <tr class ="<?php echo $rowClass; ?>">
                    ...
                    <td class="px-4 py-2">
                        <?php if (!empty($data['Photo_Barang'])): ?> <!-- Cek jika ada gambar -->
                            <img src="<?php echo htmlspecialchars($data['Photo_Barang']); ?>" alt="Foto Barang" class="w-20 h-20 object-cover"> <!-- Menampilkan gambar -->
                        <?php else: ?>
