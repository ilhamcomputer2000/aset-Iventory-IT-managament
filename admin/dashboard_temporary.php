...
$total_sql = "SELECT COUNT(*) AS total FROM peserta WHERE Status_Barang = 'TEMPORARY'";
...
<div class="flex h-screen">
        ...
        <div class="flex-1 ml-0 lg:ml-64 p-6 transition-all duration-300">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const selectedBarang = document.getElementById('selectedBarang');
                const hiddenInput = document.getElementById('filter-barang');
            ...
            <h1 class="text-2xl font-bold mb-4">Dashboard Temporary</h1>

            <p class="mb-4"></p>
            Welcome to the Asset PT CIPTA KARYA TECHNOLOGY Dashboard Temporaray!
...
$totalResult = $conn->query("SELECT COUNT(*) as total FROM peserta WHERE Status_Barang = 'REPAIR'");
