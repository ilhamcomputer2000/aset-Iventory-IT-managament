...
<aside id="sidebar" class="fixed top-0 left-0 h-screen w-60 bg-white border-r border-gray-200 z-50 transform -translate-x-full lg:translate-x-0 shadow-lg lg:shadow-none overflow-y-auto">
    ...
    <div class="px-4 py-3 border-b border-gray-200">
        <div class="flex items-center space-x-3">
            ...
            <div class="min-w-0">
                <span class="text-sm font-semibold text-gray-900 block truncate"><?php echo htmlspecialchars($Nama_Lengkap ?? 'User'); ?></span>
                <span class="text-[11px] text-gray-500 truncate block"><?php echo htmlspecialchars(($Jabatan_Level ?? '') !== '' ? $Jabatan_Level : '-'); ?></span>
            </div>
        </div>
    </div>
    ...
    <nav class="mt-2 px-3 pb-4">
        ...
        <a href="<?php echo htmlspecialchars($_sidebarLinks['dashboard']); ?>" class="flex items-center space-x-3 py-2.5 px-3 rounded-lg mb-1 transition-all duration-200 <?php echo $isDashboard ? 'bg-orange-50 text-orange-700 border-l-[3px] border-orange-500' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'; ?>">
        ...
        <a href="<?php echo htmlspecialchars($_sidebarLinks['assets']); ?>" class="flex items-center space-x-3 py-2.5 px-3 rounded-lg mb-1 transition-all duration-200 <?php echo $isAssets ? 'bg-orange-50 text-orange-700 border-l-[3px] border-orange-500' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'; ?>">
        ...
        <a href="<?php echo htmlspecialchars($_sidebarLinks['lacak']); ?>" class="flex items-center space-x-3 py-2.5 px-3 rounded-lg mb-1 transition-all duration-200 <?php echo $isLacak ? 'bg-orange-50 text-orange-700 border-l-[3px] border-orange-500' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'; ?>">
        ...
        <a href="<?php echo htmlspecialchars($_sidebarLinks['ticket']); ?>" class="flex items-center space-x-3 py-2.5 px-3 rounded-lg mb-1 transition-all duration-200 <?php echo $isTicket ? 'bg-orange-50 text-orange-700 border-l-[3px] border-orange-500' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'; ?>">
        ...
        <a href="<?php echo htmlspecialchars($_sidebarLinks['logout']); ?>" class="flex items-center space-x-3 py-2.5 px-3 rounded-lg mb-1 transition-all duration-200 text-red-500 hover:bg-red-50 hover:text-red-600">
...
<div id="notif-panel" class="fixed top-0 right-0 h-full w-full sm:w-[400px] bg-white/95 backdrop-blur-xl z-[61] shadow-2xl transform translate-x-full transition-transform duration-300 ease-in-out flex flex-col">
    ...
    <div id="notif-list" class="flex-1 overflow-y-auto">
        ...
        <div id="notif-empty" class="hidden flex-col items-center justify-center py-16 px-6">
            ...
            <p class="text-gray-400 text-sm text-center">Notifikasi akan muncul saat admin melakukan tindakan pada tiket atau pinjaman Anda.</p>
        </div>
