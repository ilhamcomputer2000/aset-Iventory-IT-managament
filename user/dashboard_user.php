...
if ($user_role !== 'user') {
    header('Location: ' . app_abs_path('user/view'));  // User ke view-only
    exit();
}
...
if ($Jabatan_Level === '' && isset($_SESSION['user_id'])) {
    ...
    if ($stmtMeta) {
        ...
        error_log('Failed to prepare user meta query (dashboard_user.php): ' . $conn->error);
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo htmlspecialchars(app_abs_path('global_dashboard.css')); ?>">
            ...
            <div class="mb-8 animate-fade-in">
                <div class="mt-16 flex flex-wrap items-start justify-between gap-4">
                    ...
                    <div class="text-right">
                        <div class="text-3xl font-extrabold text-orange-600 leading-tight">Halo,
                            <?php echo htmlspecialchars($Nama_Lengkap); ?>
                        </div>
                        <div class="text-xl font-bold text-gray-800 mt-1">Have a Nice
                            <?php echo htmlspecialchars($Hari_Nice); ?>!
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                    <div class="status-card relative overflow-hidden cursor-pointer bg-white rounded-xl shadow-lg animate-bounce-in"
                        ...
                        <a href="<?php echo htmlspecialchars(app_abs_path('user/view') . '?status_filter=READY'); ?>"
                            class="block p-6">
                    ...
                    <div class="status-card relative overflow-hidden cursor-pointer bg-white rounded-xl shadow-lg animate-bounce-in"
                        ...
                        <a href="<?php echo htmlspecialchars(app_abs_path('user/view') . '?status_filter=KOSONG'); ?>"
                            class="block p-6">
                    ...
                    <div class="status-card relative overflow-hidden cursor-pointer bg-white rounded-xl shadow-lg animate-bounce-in"
                        ...
                        <a href="<?php echo htmlspecialchars(app_abs_path('user/view') . '?status_filter=REPAIR'); ?>"
                            class="block p-6">
                    ...
                    <div class="status-card relative overflow-hidden cursor-pointer bg-white rounded-xl shadow-lg animate-bounce-in"
                        ...
                        <a href="<?php echo htmlspecialchars(app_abs_path('user/view') . '?status_filter=TEMPORARY'); ?>"
                            class="block p-6">
                    ...
                    <div class="status-card relative overflow-hidden cursor-pointer bg-white rounded-xl shadow-lg animate-bounce-in"
                        ...
                        <a href="<?php echo htmlspecialchars(app_abs_path('user/view') . '?status_filter=' . rawurlencode('IN USE')); ?>"
                            class="block p-6">
                    ...
                    <div class="status-card relative overflow-hidden cursor-pointer bg-white rounded-xl shadow-lg animate-bounce-in"
                        ...
                        <a href="<?php echo htmlspecialchars(app_abs_path('user/view') . '?status_filter=RUSAK'); ?>"
                            class="block p-6">
